...
var engine_not_running = func (index) {
    ...
    if (getprop("controls/engines/engine", index, "started")) {
        # Started control engines stop after running
        setprop("b707/generator/gen-drive", index, 0);
        setprop("b707/generator/gen-bus-tie", index, 0);
        setprop("b707/generator/gen-breaker", index, 0);
        setprop("b707/generator/gen-control", index, 0);
    };
};
...
var toggle_switch3 = func {
    setprop("/sim/sound/switch3", !getprop("/sim/sound/switch3"));
}
...
setlistener("/b707/start/ground-start", func (n) {
    if (n.getValue() == 2) {
        b707.short_startup();
        settimer(func{
        ...
        if (lsl or lsr) {
            ...
            logger.screen.red("No ALTERNATE LOW PRESS START selected in Engineer panel! ");
        }
    }
    else {
