...
var init_variables = func{
	...
	## only for the 707 - see also line 332 in the main-loop
	props.globals.getNode("/instrumentation/garmin196/selected",1).setValue(0);
...
var main_loop = func{
	...
	######  only for the boeing 707 #####
	if(getprop("/instrumentation/garmin196/selected")){
	#####################################
...
######  only for the boeing 707 #####
setlistener("/instrumentation/garmin196/selected",main_loop);
#####################################
